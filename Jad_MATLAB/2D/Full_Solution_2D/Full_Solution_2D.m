...
[Upy0_U,Upy0_V,Vpy0_U,Vpy0_V]= Define_Parameters_x_less_x1 (1,D);    
...
fprintf('\n')
Plot_Results(U_plot,V_plot,Nx,Ny,BCx2U,BCy2U,BCx2V,BCy2V,ICU,dx,Uy0_U,Uy0_V,Ux0_U,Ux0_V,x1,Upy0_U,Upy0_V,Vy0_U,Vy0_V,Vx0_U,Vx0_V,Vpy0_U,Vpy0_V,ICV,ax,bx,ay,by,dy,dt,Nt,T0,T);
