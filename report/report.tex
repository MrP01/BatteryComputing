...
if $N$ even; do
  ...
  \begin{figure}[H]
    ...
    \caption{Time evolution of in the cyclic voltammetry case for $D=1$ and $\alpha = 0.9$: the \gls{ac} potential with $\Delta E = 0.3$, where each plot represents $a(x)$, in \textcolor{blue}{blue}, and $b(x)$, in \textcolor{magenta}{magenta}, at times $t = 5, 10, 15, 25, 30, 35$. The movement on the left-hand side is dictated by the current $I(t)$ which changes over time, and is itself dependent on the concentrations of $a$ and $b$.}
  ...
  \section{Conclusion}
  Find a runtime comparison of the different approaches in \Cref{table:runtime}.
  ...
  \appendix
  \section{Remaining Results and Figures}
  \begin{figure}[H]
    \centering
    \resizebox{7cm}{!}{\inputtikz{2d-case}}
