...
\begin{document}
  ...
  Without considering the mass conservation equation $\frac{\partial a}{\partial x} + D \frac{\partial b}{\partial x} = 0$ (\Cref{eq:problem-mass-conservation}), the diffusion equations \Cref{eq:problem-pde-a} and \Cref{eq:problem-pde-b} can be
